...
#define			GPIO_MODE_OUTPUT_OD	(0x11U)  //Combination of MODER and OTYPER OD: 1 and PP:0
#define			GPIO_MODE_AF_PP			(0x02U)
#define			GPIO_MODE_AF_OD			(0x12U)

/*----------------- OSPEEDR ----------------------*/
#define			GPIO_LSP						(0x00U)
#define			GPIO_MSP						(0x01U)
#define			GPIO_HSP						(0x02U)
#define			GPIO_VHSP						(0x03U)
...
void __LIB_RCC_GPIOJ_CLK_ENABLE(void);
void __LIB_RCC_GPIOK_CLK_ENABLE(void);
